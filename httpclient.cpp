...
//    m_httpRequest.setUrl(QUrl(m_requestIPHead + "/api/clientversion/client/working/mode/query"));
    ...
    mHttpRequest.setRawHeader("hmac", "8325F5579316CA45FD9BA4F95161C1F31719145C1D20AA4D7AAB8F199C38A956A4B9323F122CF9B124575CDA41F1A3B2983732B04C8F4731CDF8B2ADB79076D7");
...
{
    qDebug()<<"httpRequestPost"<<"  appKey:"<<appKey<<"   hmacKey:"<<hmacKey;
//    QJsonObject obj;
//    obj.insert("accountId", "1");
//    QJsonDocument jsonDoc(obj);//QJsonObject转QJsonDocument
//    QString str = QString(jsonDoc.toJson());//QJsonDocument转QString
