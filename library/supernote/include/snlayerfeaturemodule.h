...
#include "config.h"
    ...
    private:
        ...
        unsigned char *m_p_comopressData = nullptr;  // 笔记压缩后
    ...
    public:
        ...
        inline unsigned char *fetchPointerCompressData() { return m_p_comopressData; }
         ...
         */
        SNFILE_RETURN_CODE fetchCompressedData(unsigned char *paraCite, size_t &dataSize);
        ...
        * @return view file sndatafile_global.h
        */
        SNFILE_RETURN_CODE setCompressedData(unsigned char *paraCite, size_t dataSize);
